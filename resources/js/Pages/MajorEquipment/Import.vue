...
<template>
    <Head title="Import Major Equipment" />
    <AuthenticatedLayout>
        ...
        <section class="max-w-3xl rounded-[2rem] border border-[#d8e7d4] bg-white p-6 shadow-sm">
            ...
            <div class="mt-6 flex gap-3"><PrimaryButton :disabled="form.processing">Import Into Miri Inventory</PrimaryButton><Link class="btn" :href="route('major-equipment.index')">Cancel</Link></div>
        </section>
    </AuthenticatedLayout>
</template>
