  ...
  <AuthenticatedLayout>
    <section class="space-y-6">
      ...
      <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        <article v-for="card in [{label:'Total licences',value:summary.total},{label:'Active',value:summary.active},{label:'Users assigned',value:summary.users_assigned}]" :key="card.label" class="rounded-[1.5rem] border border-[#d8e7d4] bg-white p-5 shadow-sm">
