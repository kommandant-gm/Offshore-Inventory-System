...
.issue-table{width:100%;border-collapse:collapse;font-size:10px}
.issue-table td,.issue-table th{border:1px solid black;padding:2px 4px;height:22px;white-space:nowrap}
.issue-table td{font-family:monospace}.issue-table th{font-size:9px;height:35px}
</style>
