...
class UpdateInventoryItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'item_code' => ['required', 'string', 'max:100', ($branchId ? Rule::unique('inventory_items', 'item_code')->where('branch_id', $branchId) : Rule::unique('inventory_items', 'item_code'))->ignore($this->route('item'))],
