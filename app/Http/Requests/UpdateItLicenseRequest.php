...
class UpdateItLicenseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'license_code' => ['required', 'string', 'max:100', Rule::unique('it_licenses')->where('branch_id', $branchId)->ignore($this->route('it_license'))],
