    ...
    public function index(Request $request): Response
    {
        ...
        $assets = $assetQuery
            ...
            ->through(fn (Asset $asset) => [
                ...
                'assigned_email' => $asset->currentAssignment?->assigned_email,
                'checkout_status' => $asset->currentAssignment?->checkout_status,
                'checkout_pending' => $asset->currentAssignment?->checkout_status === 'pending',
